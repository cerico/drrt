...
db:
	docker-compose run api bundle exec rake db:create && docker-compose run api bundle exec rake db:migrate && docker-compose run api bundle exec rake db:seed
...
build:
	docker-compose build && rm -f api/tmp/pids/server.pid &&  docker-compose up 
